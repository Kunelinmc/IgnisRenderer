...
const WEBGPU_FRAME_DIRECTIONAL_LIGHT_VEC4_COUNT =
	WEBGPU_MAX_DIRECTIONAL_LIGHTS * 2;
const WEBGPU_FRAME_POINT_LIGHT_VEC4_COUNT = WEBGPU_MAX_POINT_LIGHTS * 2;
const WEBGPU_FRAME_SPOT_LIGHT_VEC4_COUNT = WEBGPU_MAX_SPOT_LIGHTS * 3;
		...
		includeModules: [
			{
				...
				code: `#define __WEBGPU_MAX_DIRECTIONAL_LIGHTS__ ${WEBGPU_MAX_DIRECTIONAL_LIGHTS}
#define __WEBGPU_MAX_POINT_LIGHTS__ ${WEBGPU_MAX_POINT_LIGHTS}
#define __WEBGPU_MAX_SPOT_LIGHTS__ ${WEBGPU_MAX_SPOT_LIGHTS}
#define __WEBGPU_MAX_AREA_LIGHTS__ ${WEBGPU_MAX_AREA_LIGHTS}
#define __WEBGPU_MAX_LOCAL_LIGHT_PROBES__ ${WEBGPU_MAX_LOCAL_LIGHT_PROBES}
#define __WEBGPU_MAX_LOCAL_LIGHT_PROBES__u ${WEBGPU_MAX_LOCAL_LIGHT_PROBES}u
#define __WEBGPU_MAX_REFLECTION_PROBES__ ${WEBGPU_MAX_REFLECTION_PROBES}
