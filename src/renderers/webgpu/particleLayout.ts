...
export const WEBGPU_PARTICLE_INSTANCE_STRIDE = WEBGPU_PARTICLE_INSTANCE_FLOATS * 4;

export const WEBGPU_PARTICLE_UV_UNIFORM_FLOATS = 8;
export const WEBGPU_PARTICLE_UV_UNIFORM_SIZE = WEBGPU_PARTICLE_UV_UNIFORM_FLOATS * 4;
