...
- WebGPU must report `WebGPUBackend.capabilities.reflection === true`.
- WebGL must continue to report `WebGLBackend.capabilities.reflection === false`.
...
- API compatibility: no new public API is introduced.
