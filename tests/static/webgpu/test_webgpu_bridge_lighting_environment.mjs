...
const prepared = { light, lightId: light.id, definition: { bias: {}, filterMode: "pcf", sampling: { quality: "medium" }, strength: 1, projection: {} }, requestedTechnique: "single", effectiveTechnique: "single", requestedCascadeCount: 1, effectiveCascadeCount: 1, requestedResolution: 512, effectiveResolution: 512, sampling: { quality: "medium" }, requestedFilterMode: "pcf", effectiveFilterMode: "pcf", storage: "atlas", priority: 0, cost: 1, score: 1, slices: [{ index: 0, resolution: 512, view: Matrix4.identity(), projection: Matrix4.identity(), viewProjection: Matrix4.identity(), lightDirection: { x: 0, y: -1, z: 0 }, splitNear: 0, splitFar: 1 }] };
