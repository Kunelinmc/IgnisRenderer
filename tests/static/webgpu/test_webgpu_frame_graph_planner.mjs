...
const context = { scene: { decalPackets: [] }, shadowPlan: { lights: [prepared], jobs: [{ technique: "paged", lightIndex: 0, sliceIndices: [0] }], diagnostics: [], revision: 1, hasRasterWork: true, hasTransmissionWork: false, hasPagedWork: true }, backendProfile: { shadow: { supportsPagedShadows: true, supportsPagedShadowRendering: true } } };
const contributions = module.planStage({ pass, context, state: { sceneTargetMode: "mrt" }, moduleState: {} });
